...
const SearchTruck = async (event) => {
  ...
  if(event){
    ...
    if(selectedTruck.value){
      truckList.value = storeTruck.trucks.filter(c => c.id === selectedTruck.value);
              ...
              <div class="row">
                  ...
                  <v-select :options="storeTruck.trucks" v-model="selectedTruck" placeholder="Choose Truck"
                    ...
                    :class="{ 'is-invalid': formSubmitted && !selectedTruck }" />
                            ...
                            <button style="margin-bottom: -5px !important;" @click="SearchTruck" type="button" class="btn btn-info">
                              Search Truck
                             ...
                             <button style="margin-bottom: -5px !important; margin-left: 15px;" @click="openNewTruckModal" type="button" class="btn btn-primary">
                              Add Truck
                              <span class="btn-icon-end">
                                <i class= 'fa fa-add'></i>
                              </span>
                            ...
                            <table
                              ...
                              <td>
                                <div class="d-flex gap-1">
                                  <a @click="editTruck(item)" class="btn btn-warning shadow btn-xs sharp"><i class="fa fa-edit"></i></a>
                                  <a @click="deleteTruck(item)" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                </div>
                              </td>
                                </tr>
                              </tbody>
